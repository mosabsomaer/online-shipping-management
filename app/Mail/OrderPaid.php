...
class OrderPaid extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Payment Confirmed - Order #{$this->order->tracking_number}",
        );
    }
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Your payment of <strong>LYD {$total}</strong> has been successfully received.</p>

                    <div class="details">
                        <h3 style="margin-top: 0; color: #111827;">Order Details</h3>
                        <p><strong>Tracking Number:</strong> {$this->order->tracking_number}</p>
                        <p><strong>Route:</strong> {$origin} → {$destination}</p>
                        <p><strong>Container(s):</strong> {$containersList}</p>
                    </div>

                    <p style="margin-top: 30px;">
                        We are now preparing your shipment. You will receive tracking updates as your order progresses.
                    </p>
                </div>
                <div class="footer">
