...
class OrderProcessing extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Order #{$this->order->tracking_number} is Being Processed",
        );
    }
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p style="margin-top: 30px;">
                        We're working on your shipment and will notify you once it's on its way.
                    </p>
                </div>
                <div class="footer">
